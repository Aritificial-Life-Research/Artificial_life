...
namespace LD32
{
    public class EnemyInput : BaseBehaviour, IInput
    {
        ...
        BaseBehaviour target
        {
            ...
            set
            {
                ...
                if (_target != null)
                {
                    ...
                    //events on it...
                    _target.InnerBus.OnDestroy.RemoveListener(TargetDestroyed);
                }
                ...
                targetIsAlive = true;
                target.InnerBus.OnDestroy.AddListener(TargetDestroyed);
            }
        }
        ...
        public override void Awake()
        {
            ...
            InnerBus.ChangeTeam.AddListener(TeamChanged);
        }
